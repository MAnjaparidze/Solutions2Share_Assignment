...
const subMenuItem1 = (
    <div className='sub-menu__content'>
        <div>
            <h3>This is Header of Menu Item 2</h3>
            <ul>
        ...
        <div>
            <h3>My Career and Benefits 2.1</h3>
            <ul>
                <li>HRweb</li>
                <li>Benefits</li>
                <li>Learning Portal</li>
...
const subMenuItem2 = (
    <div className='sub-menu__content'>
        ...
        <div>
            <h3>My Career and Benefits 2.2</h3>
            <ul>
                <li>HRweb</li>
                <li>Benefits</li>
                <li>Learning Portal</li>
...
const subMenuItem3 = (
    <div className='sub-menu__content'>
        ...
        <div>
            <h3>My Career and Benefits 2.3</h3>
            <ul>
                <li>HRweb</li>
                <li>Benefits</li>
                <li>Learning Portal</li>
...
const subMenuItems = [
    {
        label: 'Sub Menu 2 Item 1',
        key: 'menuItem_1_item_1',
        items: subMenuItem1,
    },
    {
        label: 'Sub Menu 2 Item 2',
        key: 'menuItem_1_item_2',
        items: subMenuItem2,
    },
    {
        label: 'Sub Menu 2 Item 3',
